    ...
    toast.success(
      <div className="flex items-center gap-3">
        <div className="w-12 h-12 rounded-xl overflow-hidden shrink-0 border border-stone-200">
          <img src={meal.image || (meal.images && meal.images[0]) || ''} alt={meal.title} className="w-full h-full object-cover" />
        </div>
      ...
      {
        icon: <div className="bg-green-100 p-1 rounded-full text-green-600 shrink-0"><ShoppingCart size={16} strokeWidth={3} /></div>,
        duration: 3000,
