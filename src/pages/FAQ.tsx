...
const faqs = [
  {
    ...
    answer: "طبلية هي منصة رائدة تربطكم بنخبة من أمهر الطهاة المنزليين في طنطا. يمكنك تصفح قوائم الطعام المتنوعة، اختيار وجباتك المفضلة، وتحديد موعد التوصيل المناسب. يقوم طهاتنا بإعداد الطعام طازجاً وفق أعلى معايير الجودة ليصلكم حتى باب منزلكم."
  },
  {
  ...
  {
    question: "كيف يتم اختيار وتأهيل الطهاة؟",
    answer: "طهاة طبلية هم المبدعون في فنون الطهي المنزلي بطنطا. نحن نطبق معايير اختيار صارمة تشمل التحقق من الخلفية المهنية، مهارات الطهي، والالتزام التام بمعايير النظافة والسلامة الغذائية في مطابخهم."
  },
  {
    question: "هل يمكنني تعديل أو إلغاء الطلب؟",
    answer: "نعم، تتيح المنصة إمكانية تعديل أو إلغاء الطلب قبل بدء الشيف في عملية التحضير. وبالنسبة لخطط التوصيل الأسبوعي، يمكنك إدارة اشتراكك وتخطي أي أسبوع بسهولة من خلال إعدادات حسابك."
  },
  {
    question: "هل يمكنني الطلب من طهاة متعددين في آن واحد؟",
    answer: "بالتأكيد، تمنحكم طبلية حرية اختيار وتنسيق وجبات من طهاة مختلفين ضمن طلب واحد، لتستمتعوا بتنوع النكهات والأطباق في تجربة فريدة."
  },
  {
  ...
  {
    question: "هل تتوفر ميزة التواصل المباشر مع الشيف؟",
    answer: "نعم، توفر المنصة نظام دردشة آمن يتيح لكم التواصل المباشر مع الشيف لمناقشة أي تفاصيل خاصة بطلبكم أو تفضيلاتكم الغذائية الخاصة."
  }
];
